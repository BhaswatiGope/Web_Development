# Create API to run the application  through Web
...
# Get the loaded model pickle file

loaded_model=joblib.load("pkl_objects/model_sentiment.pkl")
loaded_stop=joblib.load("pkl_objects/stopwords.pkl")
loaded_vec=joblib.load("pkl_objects/vectorizer_sentiment.pkl")
